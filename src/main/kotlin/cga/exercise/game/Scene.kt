...
class Scene(private val window: GameWindow) {
    ...
    private var drone2Rend = ModelLoader.loadModel("assets/drone/drone.obj",Math.toRadians(-90.0f),Math.toRadians(90.0f), 0.0f) ?: throw IllegalArgumentException("Could not load the model")
    ...
    init {
        ...
        drone2Rend.scaleLocal(Vector3f(0.00025f))
        drone2Rend.translateLocal(Vector3f(0.0f,10000.0f,-1.0f))
